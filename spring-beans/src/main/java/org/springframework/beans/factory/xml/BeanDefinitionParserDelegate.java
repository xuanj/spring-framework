...
public class BeanDefinitionParserDelegate {
	...
	/**
	 * 委托方法解析Bean Parses the supplied {@code <bean>} element. May return {@code null} if
	 * there were errors during parse. Errors are reported to the
	 * {@link org.springframework.beans.factory.parsing.ProblemReporter}.
	 */
	public BeanDefinitionHolder parseBeanDefinitionElement(Element ele,
	...
	/**
	 * 对其它标签进行解析 Parse the bean definition itself, without regard to name or aliases. May
	 * return {@code null} if problems occurred during the parsing of the bean definition.
	 */
	...
	/**
	 * 具体解析就在BeanDefinitionParserDelegate类，若想知道具体怎么解析的，请查看此类即可 Parse a value, ref or
	 * collection sub-element of a property or constructor-arg element.
	 * 
